...
func TestSetSessionParams(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/tadapin/pg-dumpling/export/SkipResetDB", "return(true)"))
	defer failpoint.Disable("github.com/tadapin/pg-dumpling/export/SkipResetDB=return(true)")

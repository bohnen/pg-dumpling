...
func TestWriteTableMeta(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/tadapin/pg-dumpling/export/FailToCloseMetaFile", "return(true)"))
	defer failpoint.Disable("github.com/tadapin/pg-dumpling/export/FailToCloseMetaFile=return(true)")
...
func TestWriteTableData(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/tadapin/pg-dumpling/export/FailToCloseDataFile", "return(true)"))
	defer failpoint.Disable("github.com/tadapin/pg-dumpling/export/FailToCloseDataFile=return(true)")
